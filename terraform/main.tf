...
resource "azurerm_storage_account" "storage" {
  name                     = "nt548devsecopssttf" # Tên này phải viết liền không dấu, viết thường và duy nhất trên toàn cầu
  resource_group_name      = azurerm_resource_group.rg_tf.name # Thay 'rg' bằng tên biến resource group của bạn trong file
  location                 = azurerm_resource_group.rg_tf.location
